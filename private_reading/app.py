...
This module provides the PrivateReadingApp class that orchestrates all
...
class PrivateReadingApp:
    """Main application entry point for Private Reading.
    ...
    def _setup_logging(self):
        ...
        from private_reading.utils.logging import setup_logging
...
def main():
    """Main entry point for Private Reading application."""
    from private_reading.config import AppConfig
