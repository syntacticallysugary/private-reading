"""Command-line interface for Private Reading."""
...
def create_argument_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="private-reading",
        description="Private Reading - Convert text documents to audiobooks using TTS",
        epilog=(
            "Examples:\n"
            "  python -m private_reading -i document.md -o ./output\n"
            "  python -m private_reading -i ./documents -o ./output -w\n"
            "  python -m private_reading -i document.md -o ./output -v --reference-id my-voice-id\n"
        ),
    )
