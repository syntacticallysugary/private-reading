"""
myAudible Logging Configuration Module
======================================

This module provides structured JSON logging configuration for myAudible.
It supports multiple handlers (console, file, systemd journal) and
configurable log levels.

Usage:
    from myaudible.utils.logging_config import get_logging_config
...
def get_logging_config(
    ...
    Args:
        ...
        log_dir: Directory for log files (defaults to /opt/myaudible/logs)
    ...
    if file_handler:
        file_path = Path(log_dir) / "myaudible.log"
    ...
    # Create logger
    logger = logging.getLogger("myaudible")
...
def initialize_logging(
    ...
    return logging.getLogger("myaudible")
